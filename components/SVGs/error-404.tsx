...
export function Error404({ dimensions }: Error404Props) {
  return (
    <svg
      version="1.1"
      id="Layer_1"
    ...
    >
      <g>
        <g>
          <path
            d="M236.308,98.428c-21.717,0-39.385,17.663-39.385,39.385v68.923c0,21.721,17.668,39.385,39.385,39.385
      ...
      <g>
        <g>
          <path
            d="M0,0v324.89h472.615V0H0z M167.385,226.428h-29.538v39.385h-19.692v-39.385H49.231c-3.567,0-6.856-1.933-8.596-5.038
      ...
      <g>
        <g>
          <polygon
            points="472.615,393.846 472.615,344.582 0,344.582 0,393.846 147.692,393.846 147.692,452.923 108.308,452.923 
