...
export function LoadingMap({ dimensions }: LoadingMapProps) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <g>
        <path
          d="M42.501,32.001c-6.617,0-12,5.383-12,12s5.383,12,12,12s12-5.383,12-12S49.118,32.001,42.501,32.001z M42.501,54.001
		c-5.514,0-10-4.486-10-10s4.486-10,10-10s10,4.486,10,10S48.014,54.001,42.501,54.001z"
        />
        <path
          d="M48.501,43.001h-5v-5c0-0.553-0.447-1-1-1s-1,0.447-1,1v6c0,0.553,0.447,1,1,1h6c0.553,0,1-0.447,1-1
		S49.053,43.001,48.501,43.001z"
        />
        <path
          d="M55.085,0.19c-0.261-0.188-0.597-0.241-0.901-0.137l-17.73,5.91L19.73,2.028c-0.076-0.018-0.152-0.026-0.228-0.026
