...
export function NoLocation({ dimensions }: NoLocationProps) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <g>
        <path
          d="M279.149,78.656c-2.022-2.589-5.039-3.942-8.088-3.942c-2.207,0-4.432,0.71-6.307,2.175L19.618,268.409
        ...
        />
        <path
          d="M234.931,81.972C222.214,34.814,179.116,0,128.013,0C66.942,0,17.259,49.703,17.259,110.797
        ...
        />
        <path
          d="M87.37,259.721c17.744,20.373,32.299,33.342,33.865,34.721c1.936,1.705,4.357,2.559,6.777,2.559
